  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute bottom-6 left-4 right-4 px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 dark:bg-white/5 dark:border-white/10">
          <p className="text-xs text-gray-500">SitePilot v1.0</p>
